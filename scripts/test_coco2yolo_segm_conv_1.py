...
def display_yolo_segmentations(image_dir, yolo_annotations_dir, image_name):
    ...
    with open(annotation_path, 'r') as file:
        ...
        for line in lines:
            ...
            cv2.putText(image, str(class_id), polygon_points[0], cv2.FONT_HERSHEY_SIMPLEX, 0.5, (255, 255, 255), 2)

    # Save the image to the destination
    destination_path = "/Users/mmarzi/Desktop/conversion_test"
...
image_directory = "/Users/mmarzi/MLprojects/cv4e/datasets/data_mask/processed/images/test"
yolo_annotation_directory = "/Users/mmarzi/MLprojects/cv4e/datasets/data_mask/processed/labels/test"
sample_image_name = "Pn_delicatissima_20230601_0035_35"
