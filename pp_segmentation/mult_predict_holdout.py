...
for image in results:
    if image:
        ...
        for idx in range(0,num_masks):
            ...
            image_dir = "/home/martin/cv4e/evaluation/evaluation_data/pred_holdout/"
...
# Save to CSV 
data.to_csv("/home/martin/cv4e/evaluation/evaluation_data/pred_holdout/pred_holdout_annotations.csv", index=False)